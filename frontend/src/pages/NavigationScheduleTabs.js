...
const NavigationScheduleTabs = () => {
    ...
    const tabs = [
        { label: 'Группа', path: '/generate/group' },
        { label: 'Преподаватель', path: '/generate/teacher' },
        { label: 'Аудитория', path: '/generate/auditorium' },
    ];
    ...
    return (
        ...
        <div alignItems="right">
            ...
            <Button alignItems="right" style={{marginLeft: "10px"}} variant="dark" onClick={handleClick}>Далее</Button>
        </div>
        </div>
    );
};

export default NavigationScheduleTabs;
